    ...
    QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    Timer->start(0);
    ui->statusBar->showMessage("Ingrese un número de vértices y presione Generar",0);
    graph  = NULL;
    solutionGraph = NULL;
    createInterface();
}
